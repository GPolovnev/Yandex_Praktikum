...
- **Модуль 01 / Module 01**
  - Предобработка данных / Data Processing - *Project_1*
  - Исследовательский анализ данных / Exploratory data analysis - *Project_2*
  - Статистический анализ данных / Statistical analysis of data - *Project_3*
  - Сборный проект / Common project - *Project_4*
- **Модуль 02 / Module 02**  
  - Введение в машинное обучение / Introduction to machine learning  - *Project_5*
